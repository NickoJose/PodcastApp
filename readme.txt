...
We've also now implemented icons and thumbnails for our content across the application. We added the ability to create and delete playlists. When viewing an episode, the user has the option to click "Add to playlist" allowing them to select a playlist to add the episode to.
